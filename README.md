...
<a href='https://flathub.org/apps/com.landigit.com.auditbooks'>
...
To get the dev environment up and running you need to first set up Node.js `v22.22.2` and npm. For this, we suggest using
...
- [Telegram Group](https://t.me/Auditbooks): Used for discussions and decisions regarding everything Auditbooks.
- [GitHub Discussions](https://github.com/frappe/books/discussions): Used for discussions around a specific topic.
- [Documentation](https://landigit.com/auditbooks): Official documentation for more details.
