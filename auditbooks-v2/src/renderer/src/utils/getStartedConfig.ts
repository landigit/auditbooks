		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					documentation:
						"https://docs.www.landigit.com/auditbooks/create-initial-entries#add-taxes",
				},
			],
		},
		{
			...
			items: [
				{
					...
					documentation:
						"https://docs.www.landigit.com/auditbooks/create-initial-entries#add-sales-items",
				},
				{
					key: "Add Customers",
					...
					documentation:
						"https://docs.www.landigit.com/auditbooks/create-initial-entries#add-customers",
				},
				{
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					documentation:
						"https://docs.www.landigit.com/auditbooks/purchase-invoices#creating-purchase-invoices",
				},
			],
		},
	];
