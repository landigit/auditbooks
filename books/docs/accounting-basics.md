...
**Owner Investment**: Let say we are starting a Home Interior business and we have ₹5,00,000 of capital to start our business.
...
**Accounts Payable**: Finally, Let say we decided to hire a Web Agency to build a website for us, they charge ₹50,000 which will be paid after 2 months from current date.
...
Also, we received the money in our Bank Account directly, so its balance increases by ₹30,000.
...
You can test this out by creating a **Sales Invoice** in Auditbooks, and then check the **General Ledger Report** to see which accounts were affected.
