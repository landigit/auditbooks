...
Auditbooks allows you to customize all forms whether it's Invoice, or Party, or Item you can use the Customize Form feature to add additional fields to it.
...
You will have to reload Auditbooks to see the option, you can press `Ctrl + R` if you are on Windows or linux, or `command + R` on macOS.
...
After enabling form customization and reloading Auditbooks navigate to the Customize Form list view using the sidebar.
