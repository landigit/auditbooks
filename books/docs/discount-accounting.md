...
Discount is a deduction that is applied to the cost of an item. Auditbooks supports applying discount to an invoice on an item-wise basis.
...
::: info The discount account is an Indirect Income account, you can create it using the [Chart of Accounts](chart-of-accounts.md) :::
...
::: tip Setting Discounted Amount You can directly set the Discounted Amount, Auditbooks will automatically calculate the item rate. :::
