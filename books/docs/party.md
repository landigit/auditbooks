...
*Party* is a term used in Auditbooks for any entity to whom a Sale or from whom a Purchase is made.
...
Clicking on a row will take you to the Invoice from where [Payments can be made](payments#making-payments-from-invoices.md).
