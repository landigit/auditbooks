...
5. Enable Discount Accounting: used to enable the setting of discounts in invoices. ([link](discount-accounting.md))
6. Enable Inventory: used to enable inventory management features. ([link](introduction.md))
...
3. [Number Series](number-series.md) for transactional entries.
4. Terms to be used for certain transactional entries.
5. [Print Templates](print-templates.md) to be used when printing an entry.
...
::: tip Print View These settings can also be altered from the [Print View](sales-invoices#printing-the-sales-invoice.md) of an Invoice :::
...
3. Version: this is a read only field which tells you the current version of Auditbooks.
