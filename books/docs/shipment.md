...
To create Shipment Returns the Stock Returns feature needs to be enabled. To do this, check the **Enable Stock Returns** option in [Inventory Settings](settings.html#inventory-settings.md) under the Features section.

### Creating a Shipment Return

1. Open the Shipment entry to be returned.
2. Click on `Create / Return`. ![Create Shipment Return](images/create-shipment-return.png)
3. The Party and Item details will be fetched from the original Shipment entry. You can set the quantity of Items returned. ![Shipment Return Form](images/shipment-return-form.png)
4. Save and Submit.
