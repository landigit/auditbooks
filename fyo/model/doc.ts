...
export class Doc extends Observable<DocValue | Doc[]> {
	...
	constructor(
		...
		// biome-ignore lint/correctness/noConstructorReturn: Returning reactive(this) is intended for Vue 3 reactivity
	...
	static getTreeSettings(_fyo: Fyo): TreeViewSettings | undefined {
		return;
	}
