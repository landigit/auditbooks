...
const listenerAOnce = (value: unknown) => {
	strictEqual(params.aOne, value as number, "listenerAOnce");
};

const listenerAEvery = (value: unknown) => {
	if (counter === 0) {
		strictEqual(params.aOne, value as number, "listenerAEvery 0");
	} else if (counter === 1) {
		strictEqual(params.aTwo, value as number, "listenerAEvery 1");
	} else {
...
const listenerBOnce = (value: unknown) => {
	strictEqual(params.b, value as number, "listenerBOnce");
};
