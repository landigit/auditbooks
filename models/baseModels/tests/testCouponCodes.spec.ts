...
test("Coupon code not created: coupons min amount must be lesser than coupons max.", async (_t) => {
...
test("Coupon code not created: pricing rules max amount is lower than the coupons min.", async (_t) => {
...
test("coupon code not created: pricing rules max amount is lower than the coupons max.", async (_t) => {
...
test("coupon code is not applied when coupon's validfrom date < coupon's validTo date", async (_t) => {
...
test("coupon code is not applied when coupon's validFrom date < pricing rule's validFrom date", async (_t) => {
...
test("coupon code is not applied when coupon's validTo date > pricing rule's validTo date", async (_t) => {
