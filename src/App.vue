<template>
  ...
  >
    ...
    <div class="h-full flex flex-col overflow-hidden">
      ...
      <!-- Global Show Sidebar Button (Reopen) persistent across all pages -->
      <button
        v-if="activeScreen === 'Desk' && !showSidebar"
        class="
          absolute
          bottom-4
          start-4
        ...
        @click="() => toggleSidebar()"
      >
        <feather-icon name="chevrons-right" class="w-6 h-6" />
      </button>
...
import { showSidebar, systemLanguageRef } from "src/utils/refs";
