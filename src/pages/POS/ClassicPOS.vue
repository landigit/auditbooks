<template>
  <div>
    ...
    <div
      class="bg-gray-25 dark:bg-gray-875 grid grid-cols-1 md:grid-cols-12 gap-2 p-4 h-full md:h-[calc(100vh-var(--h-row-largest))]"
    >
      <div
        class="
      ...
      <div class="col-span-1 md:col-span-7">
        <div class="flex flex-col gap-3 h-full md:h-[calc(100vh-6rem)]">
          <div
            class="
              p-4
              bg-white
