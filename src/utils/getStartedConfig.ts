    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://www.landigit.com/auditbooks/docs/create-initial-entries#add-taxes',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://www.landigit.com/auditbooks/docs/create-initial-entries#add-sales-items',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://www.landigit.com/auditbooks/docs/create-initial-entries#add-customers',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://www.landigit.com/auditbooks/docs/purchase-invoices#creating-purchase-invoices',
        },
      ],
    },
  ];
