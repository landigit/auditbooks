      ...
      items: [
        {
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/chart-of-accounts',
        },
        {
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/setup-opening-balances',
        },
        {
          key: 'Add Taxes',
          label: t`Add Taxes`,
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/create-initial-entries#add-taxes',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/create-initial-entries#add-sales-items',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/create-initial-entries#add-customers',
        },
        {
          ...
          documentation: 'https://docs.landigit.com/auditbooks/sales-invoices',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://docs.landigit.com/auditbooks/purchase-invoices#creating-purchase-invoices',
        },
      ],
    },
  ];
