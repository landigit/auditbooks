...
import type { Money as MoneyType } from "pesa";

const { Money } =
	typeof require !== "undefined" ? require("pesa") : { Money: class {} };
...
export function safeParsePesa(value: unknown, fyo: Fyo): MoneyType {
	if (value instanceof (Money as any)) {
		return value as MoneyType;
	}
